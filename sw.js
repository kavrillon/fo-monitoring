...
var _Config = require('./scripts/config/Config');
...
self.addEventListener('fetch', function (e) {
    ...
    var dataUrl = '' + _Config2.default.trello.url + _Config2.default.trello.filters;
